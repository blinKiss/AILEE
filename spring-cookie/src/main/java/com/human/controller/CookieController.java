...
public class CookieController {
	...
	public String cookie(HttpServletRequest request, Model model) {
		...
		if (cookies != null) {
			for (Cookie cookie : cookies) {
				String cookieName = cookie.getName(); // 쿠키이름
	...
	public ResponseEntity<String> createCookie(HttpServletRequest request, HttpServletResponse response) {
...
//		headers.add(HttpHeaders.SET_COOKIE, cookie.toString());
	...
	public ResponseEntity<String> deleteAllCookie(HttpServletRequest request, HttpServletResponse response) {
